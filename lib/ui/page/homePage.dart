...
import 'package:flutter_twitter/model/push_notification_model.dart';
import 'package:flutter_twitter/resource/push_notification_service.dart';
import 'package:flutter_twitter/state/appState.dart';
import 'package:flutter_twitter/state/authState.dart';
import 'package:flutter_twitter/state/chats/chatState.dart';
import 'package:flutter_twitter/state/suggestionUserState.dart';
import 'package:flutter_twitter/state/feedState.dart';
import 'package:flutter_twitter/state/notificationState.dart';
import 'package:flutter_twitter/state/searchState.dart';
import 'package:flutter_twitter/ui/page/feed/feedPage.dart';
import 'package:flutter_twitter/ui/page/feed/feedPostDetail.dart';
import 'package:flutter_twitter/ui/page/feed/suggestedUsers.dart';
import 'package:flutter_twitter/ui/page/message/chatListPage.dart';
import 'package:flutter_twitter/ui/page/profile/profilePage.dart';
import 'package:flutter_twitter/widgets/bottomMenuBar/bottomMenuBar.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (context.select<SuggestionsState, bool>((state) => state.displaySuggestions)) {
      //vinhnt
